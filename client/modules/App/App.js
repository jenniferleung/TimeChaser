...
class SearchBar extends React.Component {
  ...
  handleSubmit(event) {
    ...
    if(reg.test(this.state.inputValue)){
      fetch('http://api.translink.ca/RTTIAPI/V1/stops/'+this.state.inputValue+'?apiKey='+keys['TRANSLINK_API_KEY']+'&lat=49.187706&long=-122.850060', {headers: {accpet: 'application/JSON'}})
        .then( (res) =>{
